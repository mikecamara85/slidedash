...
if (require.main === module) {
  ...
  const narrationText =
    "Rev up your senses with the sleek 2021 Alfa Romeo Giulia Ti, glimmering in a lustrous silver hue.  This Italian masterpiece, with just 41,287 miles under its' belt, boasts a vivacious 2-liter, 4-cylinder engine paired with a swift 8-speed automatic transmission.  Fully equipped with modern luxuries, including keyless ignition, a panoramic sunroof, and a suite of safety features like forward collision warning and automatic braking, this Giulia is the epitome of style fused with innovation.  Visit Auto Gals, in Fall River or Swansea, to take it for a spin today!";
